...
@JsonSubType(value = "AI")
public class AiReaderVO extends ReaderVO {

    private String api = "http://172.25.20.12:11434";

    private AiProviderVO<? extends AiModelOptionsVO> provider;

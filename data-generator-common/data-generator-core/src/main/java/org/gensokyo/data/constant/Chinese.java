 ...
 * @author Gensokyo V.L.
 * @version 1.0.0
 * @since 2024/3/11 , Version 1.0.0
 */
public class Chinese {

    public static final String[] SUR = new String[]{"赵",
    ...
    public static final String[] DOUBLE_SUR = new String[]{"万俟",
    ...
    public static final String[] ETHNIC_SUR = new String[]{"萨嘛喇", "赫舍里", "萨克达", "钮祜禄", "他塔喇", "喜塔腊", "库雅喇", "瓜尔佳",
            "舒穆禄", "索绰络", "依尔觉罗", "额尔德特", "叶赫那拉", "讷殷富察", "叶赫那兰", "爱新觉罗", "依尔根觉罗"};

    public static final String[] WORD = new String[]{"阿",

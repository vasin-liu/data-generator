 ...
 */
public class OracleDialectImpl extends CommonsDialectImpl {

    //https://docs.oracle.com/cd/A97630_01/appdev.920/a42525/apb.htm
    public static final Set<String> KEYWORDS = Set.of(
            "MODIFY", "EXCLUSIVE", "NOAUDIT", "SESSION", "FILE",
            "NOTFOUND", "SHARE", "NOWAIT", "SQLBUF", "SUCCESSFUL", "AUDIT",
            "OFFLINE", "SYNONYM", "SYSDATE", "IMMEDIATE", "ONLINE",
            "INCREMENT", "TRIGGER", "COLUMN", "INITIAL", "UID", "COMMENT", "PRIVILEGES", "RAW", "USER", "VALIDATE", "LOCK", "ROW",
    ...
    public OracleDialectImpl() {
        this(PaginationProcessor.ORACLE);
    }

    public OracleDialectImpl(PaginationProcessor paginationProcessor) {
        this(new KeywordWrap(false, true, KEYWORDS, "\"", "\""), paginationProcessor);
    }

    public OracleDialectImpl(KeywordWrap keywordWrap, PaginationProcessor paginationProcessor) {

# Requirements Archive: v2.0 Reader/Writer & Datasource Platform
...
|--------|---------|-------|
| DS-01..DS-05 | Validated | Platform + governance + Phase 07.1 snap routing |
| RW-01..RW-04 | Validated | Streaming CSV/JSON + PG/MySQL upsert |
| RW-05..RW-06 | Validated | Five-engine dialects; Dameng live IT opt-in |
| TEST-07..TEST-08 | Validated | 15-row P0 gate green |

**Dropped:** none
**Adjusted:** DS-02/RW-05/RW-06 proof depth closed in Phase 11 with accepted in-process / non-single-JVM limits (see audit tech_debt)

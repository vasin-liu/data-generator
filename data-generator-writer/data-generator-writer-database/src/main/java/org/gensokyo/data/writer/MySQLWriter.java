...
public class MySQLWriter<S extends WriteStageVO, T extends MySQLWriterVO> implements Writer<S, T> {
    ...
    public long write(final StageContext<S> ctx, final T wvo, final List<Map<String, Object>> dataset) {
        ...
        try {
            ...
            if (ps.isWrapperFor(com.mysql.cj.jdbc.JdbcStatement.class)) {
                ...
                jps.setLocalInfileInputStream(DatasetKit.buildBulkData(wvo.getTemplate(), dataset));

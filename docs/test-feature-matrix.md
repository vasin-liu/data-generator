...
| reader-jdbc-basic | reader-jdbc | jdbc | integration | data-generator-test-fixtures | partial | FixtureReaderJdbcExampleTests |
...
| writer-jdbc-basic | writer-jdbc | jdbc | integration | data-generator-test-fixtures | partial | FixtureWriterJdbcExampleTests |
...
| transform-sql-basic | transform-sql | calcite-sql | integration | data-generator-test-fixtures | partial | FixtureTransformSqlExampleTests |
...
| console-ui-job-trigger | console-ui-job-trigger | console-ui | e2e | data-generator-console-web | partial |  |
